...
proc_macros::define_core_struct! {
    ...
    [] [
        #[
            Public {Static}
            CoreTypeRef::WithGeneric(CoreTypeId::System_Reference_1, vec![CoreTypeRef::Generic(0)]), // this
            CoreTypeRef::Core(CoreTypeId::System_USize), // size
            CoreTypeRef::Generic(0), // result
        ]
        Read (
            #[{ByRef}] CoreTypeRef::WithGeneric(CoreTypeId::System_Reference_1, vec![CoreTypeRef::Generic(0)])
        ) -> CoreTypeRef::Generic(0);
        #[
            Public {Static}
            CoreTypeRef::WithGeneric(CoreTypeId::System_Reference_1, vec![CoreTypeRef::Generic(0)]), // this
            CoreTypeRef::Generic(0), // data
            CoreTypeRef::Core(CoreTypeId::System_USize), // size
        ]
        Write (
            #[{ByRef}] CoreTypeRef::WithGeneric(CoreTypeId::System_Reference_1, vec![CoreTypeRef::Generic(0)])
